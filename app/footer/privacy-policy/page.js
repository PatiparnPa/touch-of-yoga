    ...
    return (
        <>
            ...
            <div className={styles.content}>
                <p className={styles.indent}>This Privacy Policy describes how TouchofYoga (the "Site", "we", "us", or "our") collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from www.touchofyoga.com (the "Site") or otherwise communicate with us (collectively, the "Services"). For purposes of this Privacy Policy, "you" and "your" means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy.</p>
                ...
                <h1>How We Collect and Use Your Personal Information</h1>
                <p className={styles.indent}>To provide the Services, we collect and have collected over the past 12 months personal information about you from a variety of sources, as set out below. The information that we collect and use varies depending on how you interact with us.</p>
                <p className={styles.indent}>In addition to the specific uses set out below, we may use information we collect about you to communicate with you, provide the Services, comply with any applicable legal obligations, enforce any applicable terms of service, and to protect or defend the Services, our rights, and the rights of our users or others.</p>
                ...
                <h1>Information We Collect Directly from You</h1>
                <h3>Information that you directly submit to us through our Services may include:</h3>
                ...
                <ul className={styles.slashUnderList}>
                ...
                <p>network activity, such as</p>
                <p>Usage Data <span className={styles.boldText}> Categories of:</span></p>
                <p><span className={styles.boldText}> Receipts</span></p>
                ...
                <p>marketing</p>
                <p>partners</p>
                <p><span className={styles.boldText}>User</span></p>
                <p><span className={styles.boldText}>Generated</span></p>
                <p><span className={styles.boldText}>Content</span></p>
                ...
                <p>Our Site may provide links to websites or other online platforms operated by third parties. If you follow links to sites not affiliated or controlled by us,</p>
                <p>you should review their privacy and security policies and other terms and conditions. We do not guarantee and are not responsible for the privacy or security of such sites, including the accuracy, completeness, or reliability of information found on these sites. Information you provide on public or semi- public venues, including information you share on third-party social networking platforms may also be viewable by other users of the Services and/or users of those third-party platforms without limitation as to its use by us or by a third party. Our inclusion of such links does not, by itself, imply any endorsement of the content on such platforms or of their owners or operators, except as disclosed on the Services.</p>
...
<br></br>
                <div className={styles.bottomGreen}>
                    <div className={styles.bottomTextGray}>Powered by Shopify</div>
                    <div className={styles.bottomTextGreen}>www.shopify.com</div>
                </div>
            </div>
            <Footer />
        </>
