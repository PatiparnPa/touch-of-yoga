...
export default function GoldVermeil() {
    return (
        <>
            <div
            ...
            >
                {/* First Image */}
                <Image
                    src="/jpg-footer/gold-vermeil/gold-vermeil1.jpg"
                    alt="Gold Vermeil Page 1"
                    layout="responsive"
                    width={800}
                    height={1200}
                    objectFit="contain"
                ...
                />
                <Image
                    src="/jpg-footer/gold-vermeil/gold-vermeil2.jpg"
                    alt="Gold Vermeil Page 2"
                    layout="responsive"
                    width={800}
                    height={1200}
                    objectFit="contain"
