    ...
    return (
        <>
            ...
            >
                {/* First Image */}
                <Image
                    src="/jpg/our-heritage/our-heritage1.jpg"
                ...
                {/* Second Image */}
                <Image
                    src="/jpg/our-heritage/our-heritage2.jpg"
                    alt="Our Heritage Page 2"
                    layout="responsive"
                    width={800}
                    height={1200}
                    objectFit="contain"
                ...
                />
                <Image
                    src="/jpg/our-heritage/our-heritage3.jpg"
                    alt="Our Heritage Page 3"
                    layout="responsive"
                    width={800}
                    height={1200}
                    objectFit="contain"
                ...
                />
                <Image
                    src="/jpg/our-heritage/our-heritage4.jpg"
                    alt="Our Heritage Page 4"
                    layout="responsive"
                    width={800}
                    height={1200}
                    objectFit="contain"
