...
function CollectionFirstPageBracelet() {
  return (
    <div className={styles.container}>
      <h1 className={styles.heading}>Bracelet</h1>
      ...
      <div className={styles.gridSubCollection}>
        ...
        <div className={styles.smallItem}>
          <Image
            ...
            objectFit="cover"
          />
          <span className={styles.imageText}>Gold Bracelet</span>
        </div>
        <div className={styles.smallItem}>
          <Image
            src="/images/collections/collection3.jpg"
...
export default CollectionFirstPageBracelet;
